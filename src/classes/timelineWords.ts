...
export const explanation: Timelines = {
  start: [
    { type: 'event', event: 'chdir', props: ['notMob', 'left'] },
    { type: 'event', event: 'log', props: ['notMob', 3] },
    ...
    { type: 'event', event: 'log', props: ['notMob', 1] },
    {
      type: 'dialog',
      actorName: 'ダカフ',
    ...
    { type: 'event', event: 'log', props: ['notMob', 4] },
    {
      type: 'dialog',
      actorName: 'ダカフ',
    ...
    { type: 'event', event: 'log', props: ['notMob', 5] },
    {
      type: 'dialog',
      actorName: 'ダカフ',
    ...
    { type: 'event', event: 'reset', props: ['stoper2'] },
    { type: 'event', event: 'reset', props: ['stoper3'] },
    { type: 'event', event: 'reset', props: ['stoper4'] },
    { type: 'event', event: 'reset', props: ['stoper5'] },
    { type: 'event', event: 'reset', props: ['stoper6'] },
    { type: 'event', event: 'reset', props: ['stoper7'] },
    { type: 'event', event: 'reset', props: ['stoper8'] },
    {
      type: 'event',
      event: 'kill',
      props: [
