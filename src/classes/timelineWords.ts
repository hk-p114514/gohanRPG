...
export const prologue: Timelines = {
  start: [
    { type: 'dialog', actorName: 'マルク', text: 'はぁーあ、最近のヤトウはロクなのがいねぇなぁ…ん？' }, 
    { type: 'dialog', actorName: 'マルク', text: '魔王を倒せたら大盛りご飯無料？？' }, 
    { type: 'dialog', actorName: 'マルク', text: 'へぇ…腹減ってんだ、ちょうどいい' }, 
    { type: 'dialog', actorName: 'マルク', text: '魔王でもヤトウでも、俺が倒してやろうじゃねーか' },
    { type: 'endTimeline' },
  ]
}
...
export const beforeAteBattle: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'エーテ', text: 'ふん、初対面で随分偉そうな口を聞くじゃないか…' },
    { type: 'dialog', actorName: 'エーテ', text: 'この私が、魔王直属の四天王の一人、エーテ様と知っての言葉ではあるまいな！' }, 
    ...
    { type: 'dialog', actorName: 'エーテ', text: '母なる魔王の元へ行きたくば、この私を倒していくがいい！' }, 
    { type: 'dialog', actorName: 'エーテ', text: '魔王を倒そうなどという愚かな試み、この場でへし折ってくれるわ！' }, 
    { type: 'endTimeline' }, 
  ]
}
...
export const afterAteBattle: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'エーテ', text: '俺は、四天王なんだ…こんな所で、倒れる訳にはいかないんだ…！' }, 
    { type: 'dialog', actorName: 'エーテ', text: '俺を生み出しし母、OBCの為に…！' }, 
    { type: 'dialog', actorName: 'マルク', text: 'OBC？なんだそれ？' }, 
    { type: 'dialog', actorName: 'エーテ', text: 'ふん、覚えておくといい…いずれ貴様を滅ぼす、偉大なる魔王の名だ…' }, 
    { type: 'dialog', actorName: 'エーテ', text: 'バタッ' }, 
    { type: 'dialog', actorName: 'マルク', text: '…死に際に色々吐いてくれる系四天王だったな…' }, 
...
export const meetShiden: Timelines = {
  start: [
    { type: 'dialog', actorName: 'シデン', text: 'このソースワデザートに人が来るとは珍しい…何用だ' }, 
    { type: 'dialog', actorName: 'マルク', text: 'おう、俺はマルク\n魔王を倒すために旅してんだ' }, 
    { type: 'dialog', actorName: 'シデン', text: 'そのために、砂漠の四天王を倒しに来たと…' }, 
    { type: 'dialog', actorName: 'マルク', text: 'そういうことだ' }, 
    { type: 'dialog', actorName: 'シデン', text: '…まさかとは思うが、魔法も使えないのに1人で行くつもりじゃないだろうな' }, 
    { type: 'dialog', actorName: 'マルク', text: 'よくそこまで分かったな' }, 
    { type: 'dialog', actorName: 'シデン', text: '杖も持ってないやつに魔法なんか使えるか' }, 
    { type: 'dialog', actorName: 'シデン', text: 'ここ一体の魔物は、砂塵から身を守るための硬い体を持つものが多い' }, 
    { type: 'dialog', actorName: 'シデン', text: '物理攻撃だけで突破するのは、正直無謀と言える' }, 
    { type: 'dialog', actorName: 'マルク', text: 'なるほどな…そんで、お前魔法使えんの？' }, 
...
export const beforeBteBattle: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'ビーテ', text: 'そうだ\nそしてこの私こそ、軟弱な兄エーテよりずっとずっと強い、\n砂漠の四天王ビーテ様だ！' },
    ...
    { type: 'dialog', actorName: 'ビーテ', text: '貴様ら、黙って聞いておればビーテ様を侮辱しおって！' },
    { type: 'dialog', actorName: 'シデン', text: '黙ってはなかったぞ' },
    { type: 'dialog', actorName: 'ビーテ', text: '揚げ足ばかり取るなまどろっこしい！！' },
    { type: 'dialog', actorName: 'ビーテ', text: 'どうやら、戦って分からせてやる必要がありそうだな…' },
    { type: 'dialog', actorName: 'マルク', text: 'うわー脳筋だ' },
    { type: 'dialog', actorName: 'シデン', text: '間違いないな' }, 
    { type: 'dialog', actorName: 'ビーテ', text: 'やかましい！！少しは勇者らしいセリフとか吐けんのか！！' },
    { type: 'dialog', actorName: 'マルク', text: 'ほら論点ずらした' },
    { type: 'dialog', actorName: 'ビーテ', text: '言っとくけど現時点でお前らの方が印象悪いからな！' }, 
    { type: 'dialog', actorName: 'シデン', text: 'くどい\n早くバトルしろ' },
    { type: 'dialog', actorName: 'ビーテ', text: 'お前らのせいで伸びたんだろ！！おらぁ！！' }, 
...
export const afterBteBattle: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'ビーテ', text: 'これじゃ、あの兄者と一緒じゃないかぁ…' },
    ...
    { type: 'dialog', actorName: 'メルシン', text: '我々四天王の名を汚してもらっては困るのですよ' },
    { type: 'dialog', actorName: 'メルシン', text: '…という訳でOBC、次はワタクシが奴らを仕留めて参りましょう' },
...
export const addShiden: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'マルク', text: 'おぉ！助かるけど、何か理由でもあるのか？' }, 
    { type: 'dialog', actorName: 'シデン', text: '魔王にまつわる黒い噂は知っているな？' },
    { type: 'dialog', actorName: 'マルク', text: '知らん' },
    { type: 'dialog', actorName: 'シデン', text: '全く、倒そうとしているんじゃないのか…' },
    { type: 'dialog', actorName: 'シデン', text: 'まぁいい、教えてやるから覚えておけ' },
    { type: 'dialog', actorName: 'シデン', text: '魔王の侵略地域、黒い霧が広まっているのは知っているな？' },
    { type: 'dialog', actorName: 'マルク', text: 'そうなの？' },
    { type: 'dialog', actorName: 'シデン', text: '本当に何も知らないんだな…' },
    { type: 'dialog', actorName: 'シデン', text: '魔王に占拠された食堂の周りから、少しずつ黒い霧が広まってるんだよ' },
    { type: 'dialog', actorName: 'マルク', text: 'へぇ〜、黒い霧に包まれるとどうなるんだ？' },
    { type: 'dialog', actorName: 'シデン', text: 'そこが問題なんだよ！！' },
    { type: 'dialog', actorName: 'マルク', text: '急に熱くなるじゃん' },
    { type: 'dialog', actorName: 'シデン', text: 'そりゃ熱くもなるさ！なにせ、黒い霧に包まれた場所では…' },
    { type: 'dialog', actorName: 'マルク', text: 'ゴクリ…' },
    { type: 'dialog', actorName: 'シデン', text: '全ての料理の味付けが、超濃い目になってしまうんだよ！！！' }, 
    { type: 'dialog', actorName: 'マルク', text: '…はぁ' },
    { type: 'dialog', actorName: 'シデン', text: '俺はな、薄味が好みなんだよ！！' },
    { type: 'dialog', actorName: 'マルク', text: 'お、おぅ' },
    { type: 'dialog', actorName: 'シデン', text: 'このまま黒い霧が広まって、世界中を包み込み、\n薄味の食べ物が無くなるなんて論外だ！'},
    { type: 'dialog', actorName: 'シデン', text: 'その前に俺がこの手で、魔王を打ち倒す！' },
    { type: 'dialog', actorName: 'マルク', text: '…まぁ着いてきてくれるならなんでもいいや'},
    { type: 'endTimeline' },
  ]
}
...
export const addPouler: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'パウラ', text: 'でも、お父さんとお母さんを助けたいんです！' },
    { type: 'dialog', actorName: 'マルク', text: '…詳しく聞かせてくれ' }, 
    { type: 'dialog', actorName: 'パウラ', text: '最近、このムギムギオーシャンの一帯にも黒い霧の影響が出始めてるんです' },
    { type: 'dialog', actorName: 'パウラ', text: 'そのせいで水分が足りず、両親が渇きを訴えていて…' },
    { type: 'dialog', actorName: 'パウラ', text: '水を飲めば一時的には治りますが、食事もままならなくなってしまい…' },
    { type: 'dialog', actorName: 'マルク', text: '…分かった、着いて来い' },
    { type: 'dialog', actorName: 'パウラ', text: '本当ですか！' },
    { type: 'dialog', actorName: 'シデン', text: 'いいのか！マルク！' },
    { type: 'dialog', actorName: 'マルク', text: '食事もままならない状況じゃ、放っておいてもこの子は飢え死にするかもしれねぇだろ' },
    { type: 'dialog', actorName: 'マルク', text: 'なら、連れて行って魔王倒して、一緒に両親も救った方がいいだろ' },
    { type: 'dialog', actorName: 'パウラ', text: 'あ、ありがとうございます！\n回復魔法が使えるので、一生懸命がんばります！' },
    { type: 'endTimeline' },
  ]
}
...
export const beforeMelcineBattle: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'メルシン', text: 'この高貴なワタクシを、あんな力押しの兄弟と一緒にされては困るのですよ！' },
    { type: 'dialog', actorName: 'メルシン', text: 'やつらは四天王の面汚しに済みません…' },
    { type: 'dialog', actorName: 'メルシン', text: 'このワタクシが、四天王の真の恐ろしさ、思い知らせて差し上げましょう！！' },
    { type: 'endTimeline' },
  ]
}
...
export const afterMelcineBattle: Timelines = {
  start: [
    ...
    { type: 'dialog', actorName: 'メルシン', text: 'こんな無様な幕引きなんて、認めません、認めませんよォォォ！！！' },
    { type: 'dialog', actorName: 'マルク', text: 'ごちゃごちゃうるせぇ野郎だな、とっとと行こうぜ' },
    ...
    { type: 'dialog', actorName: 'OBC', text: 'ふん、言うじゃないか…\n言わずもがな、次はお前の番さ' },
    { type: 'dialog', actorName: 'エレカ', text: '分かっているわ\nお母様の元へは、虫けら1匹通しはしない…' },
    { type: 'endTimeline' },
  ]
}
